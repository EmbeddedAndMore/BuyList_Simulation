...
class ScrapOptimization:
    ...
    def optimize(self, total_quantity:float, chemi_component:list, selected_stahl_name:str, ns,supplier_quantity_hist,sim_id_hist):
        ...
        # [x1, x2, x3, strom_price]: `sum_t3_xgb` and `sum_t3_tf` should be modified
        
        # list to test: strom_price [0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.2]
        ...
        # In general there should be 8x8=64 combinations, we don't have to do that, just randomly choose some 
        # combinations, around 20 should be fine
        ...
        # take care of main.py global_lock.acquire() and global_lock.release()
